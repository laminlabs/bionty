...
- Access >20 public ontologies (Gene, Protein, CellType, …) through a single API, served from S3 with high availability and low latency given some of the original ontology services are unreliable.
